    ...
    for i in range(0,num):
        ...
        if(re1['msgType']=='TEXT'):
            ...
            if(re2['messageType'] == 'LIVEPUSH'):
                ...
                color_win.printDarkGreen(box)
                print("--------------普通翻牌---------------")
                timeStamp((re1['msgTime']))
                print("小偶像普通翻牌啦！")
                print("粉丝："+re2['replyName'])
                print("提问:"+(emoji.demojize(re2['replyText'])))
                print(re2['user']['nickName']+"回答:"+emoji.demojize(re2['text']))
                print("----------------—END——--------------")

            elif(re2['messageType'] == 'FLIPCARD'):
                color_win.printDarkYellow(box)
                print("--------------鸡腿翻牌---------------")
                timeStamp((re1['msgTime']))
                print("小偶像鸡腿翻牌啦！")
                ...
                print("用户发送内容:")
                print(emoji.demojize(re1['bodys']))
                #print("用户使用型号")
